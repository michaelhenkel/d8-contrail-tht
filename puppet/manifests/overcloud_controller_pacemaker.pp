...
$neutron_enable_opencontrail = hiera('neutron_enable_opencontrail', false)
$neutron_enable_ml2 = !$neutron_enable_opencontrail
...
if hiera('step') >= 3 {
  ...
  if hiera('neutron_enable_opencontrail', false) {
